...
```{r define function to calculate net effect of variants, fig.width=24, fig.height=8}
...
```{r define function to calculate net effect of treatments, fig.width=24, fig.height=8}
